...
Implement the timeline data structure in moron-core. The timeline tracks the progression of a video from start to finish — it contains segments (narration, animation, silence) and resolves to frame numbers at a given FPS.
